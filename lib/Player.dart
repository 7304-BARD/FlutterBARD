...
class Player {
  ...
  Player(Document html) { populate(html); }
  Future<Null> populateAsync() => dpgsGetPlayerRaw(pgid).then((h) => populate(h));
  ...
  populate(Document html) {
    ...
    pos = html.querySelector("#ContentPlaceHolder1_Bio1_lblPrimaryPosition").text;
    pos2 = html.querySelector("#ContentPlaceHolder1_Bio1_lblOtherPositions").text;
    ...
    teamSummer = html.querySelector("#ContentPlaceHolder1_Bio1_lblSummerTeam").text;
  ...
  void addIfNonNull(List<Tuple2<String, String>> list, String key, String value) {
    if (value != null)
